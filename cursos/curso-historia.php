<main class='page curso' id="conteudoPrincipal">
  ...
  <section class="destaque destaque-imagem" style="background-image: linear-gradient(#043166, transparent), url('<?php echo get_template_directory_uri() ?>/img/capas/historia.jpg')"></section>
...
<!--
      ...
      <div>
        ...
        <p>-autonomia intelectual; <p>
        <p>-pensamento reflexivo;<p>
        <p>-capacidade para atuar de forma ética, crítica e criativa na busca de soluções para as questões que lhe são apresentadas pela sociedade; <p>
        <p>-capacidade para trabalhar em equipes interdisciplinares;<p>
        <p>-criatividade, iniciativa e flexibilidade nas relações inter-pessoais e profissionais;<p>
        <p>-respeito à diversidade própria dos ambientes profissionais; <p>
        <p>-compreensão dos elementos e dos processos relativos ao meio natural e ao construído; <p>
        <p>-sólida fundamentação filosófica, teórica e metodológica; <p>
        <p>-capacidade de aplicar o conhecimento em prol do desenvolvimento social; <p>
        <p>-disposição para o aprendizado contínuo;<p>
        <p>-capacidade de se interagir com as Novas Tecnologias de Informação e de Comunicação (NTICs), tendo-as como instrumentos que possam contribuir para o desenvolvimento de um trabalho reflexivo e crítico;</p>
        <p>-domínio e constante aprimoramento das abordagens científicas inerentes ao processo de produção e aplicação do conhecimento em História;</p>
        <p>-conhecimento e sobre o uso das novas tecnologias de informação e comunicação a serem utilizados no seu cotidiano profissional e social.</p>
        <p>-dominar as diferentes concepções metodológicas que referenciam a construção de categorias para a investigação e a análise das relações sócio-históricas; </p>
        ...
        <p>-domínio dos conteúdos básicos que são objeto de ensino-aprendizagem no ensino fundamental e médio; </p>
        <p>-domínio dos métodos e técnicas pedagógicos que permitam a transmissão do conhecimento para os diferentes níveis de ensino;</p>
