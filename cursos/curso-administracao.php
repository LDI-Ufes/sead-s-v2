<main class='page curso' id="conteudoPrincipal">
  ...
  <section class="destaque destaque-imagem" style="background-image: linear-gradient(#043166, rgba(4, 49, 102, 0.3)), url('<?php echo get_template_directory_uri()?>/img/capas/administracao.jpg')"></section>
