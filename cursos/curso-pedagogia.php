    ...
    <section id='conteudo'>
      ...
      <aside id='menu'>
        ...
        <ul>
          ...
          <a href='<?php echo get_template_directory_uri(); ?>/arquivos/pedagogia/Guia-do-estudante-Pedagogia.pdf' target='_blank' title='Abrir o Guia do Aluno em nova aba'>Guia do aluno <i class='fas fa-external-link-alt'></i></a>
