...
<main id="conteudoPrincipal" class='container page page-polos'>
  ...
  <section>
    ...
    <p>A Superintendência de Educação a Distância-SEAD da Universidade Federal do Espírito Santo-UFES está presente em 27 polos de apoio presencial da Universidade Aberta do Brasil (UAB), estratégicamente espalhados por várias regiões do estado do Espírito Santo.</p>
  </section>
