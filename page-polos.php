...
<main id="conteudoPrincipal" class='container page page-polos'> 
  ...
  <section class="container-texto"> 
    ...
    <blockquote>O objetivo dos polos é oferecer o espaço físico de apoio presencial aos estudantes da sua região, mantendo as instalações físicas necessárias para atender aos estudantes em questões tecnológicas, de laboratório, de biblioteca, entre outras.</blockquote> 
