    ...
    <main>
      <section id="ead-na-ufes">
        ...
        <div class="topico-ead">
          <figure>
            <?php echo file_get_contents(get_template_directory_uri() . '/svg/ingresso.svg'); ?>
        ...
        <div class="topico-ead">
          <figure>
            <?php echo file_get_contents(get_template_directory_uri() . '/svg/ava.svg'); ?>
        ...
        <div class="topico-ead">
          <figure>
            <?php echo file_get_contents(get_template_directory_uri() . '/svg/polos-uab.svg'); ?>
      ...
      <section id="noticias">
        ...
        <div class="confira-mais">
          ...
          <button title="Vá para a página Blog"><?php echo file_get_contents(get_template_directory_uri() . '/svg/nossoBlog.svg'); ?></button>
        </div>
      </section>

      <section id="polos">
        <?php echo file_get_contents(get_template_directory_uri() . '/svg/mapaInicio.svg'); ?>
