...
<html lang="pt-BR" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>/wp-content/themes/sead-v2/css/page.css">
  ...
  <body>
      ...
      <main>
            <div class="video gradient">
                ...
                <h1>Secretaria de Ensino a Distância</h1>
            </div>
            <div class="container">
                <section id="breadcrumbs">Você está em: <a>Ensino</a> > <span>Sobre a Secretaria</span></section>
            </div>
