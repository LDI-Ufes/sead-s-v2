...
<main class="page" id="ead-na-ufes">
  ...
  <div class="container">
    ...
    <section id="destaques">
      <ul>
        <li><?php include 'svg/encontros-pres.svg' ?><div><h2>Encontros presenciais</h2>O encontro presencial semanal obrigatório se dará com pequenos grupos de alunos e o tutor presencial nas salas e laboratórios em cada Polo UAB integrado ao curso.</div></li>
        <li><?php include 'svg/encontros-pres.svg' ?><div><h2>Momentos semipresenciais</h2>Os encontros semipresenciais entre alunos, tutores e professores especialistas ocorrerão no AVA e nas webconferências conforme planejamento do curso ou necessidade para esclarecimentos e aprofundamento de conteúdos.</div></li>
        <li><?php include 'svg/encontros-pres.svg' ?><div><h2>Ambiente Virtual de Aprendizagem (AVA)</h2>A Plataforma Moodle trata-se de um sistema de gerenciamento de grupos de estudo, para dar suporte aos cursos oferecidos na modalidade a distância da Ufes, acompanhamento e ajuda ao aluno, executada no AVA e acessível via interface WEB.</div></li>
      </ul>
    </section>
